    ...
    public partial class Karyawan : Form
    {
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("Insert into KaryawanTbl(KNama,KNomor,KJenisKelamin,KAlamat) values(@Kn,@Km,@Kj,@Ka)", con);
        ...
        private void EditBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Update KaryawanTbl set KNama=@Kn,KNomor=@Km,KJenisKelamin=@Kj,KAlamat=@Ka where KId=@Kid", con);
                cmd.Parameters.AddWithValue("@Kn", KNamaTb.Text);
                cmd.Parameters.AddWithValue("@Km", KNomorTb.Text);
                cmd.Parameters.AddWithValue("@Kj", KJenisKelaminCb.SelectedItem.ToString());
                cmd.Parameters.AddWithValue("@Ka", KAlamatTb.Text);
